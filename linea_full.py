...
~90 ETF: tutti i 53 attuali + WT + leva 2x + leva 3x
Top 15 dinamici per score. Short attivi con segnali KAMA.
Benchmark: IWMO.MI
"""
...
def main():
    ...
    output = {
        ...
        "linea":       "Full",
        "descrizione": f"{len(UNIVERSO_LONG)} ETF long + {len(UNIVERSO_SHORT)} short — top 15 dinamici — benchmark IWMO",
